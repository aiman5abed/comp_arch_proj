...
typedef enum {
    ...
    OP_BEQ  = 9,    // if (R[rs] == R[rt]) pc = R[rd][9:0]
    OP_BNE  = 10,   // if (R[rs] != R[rt]) pc = R[rd][9:0]
    OP_BLT  = 11,   // if (R[rs] < R[rt]) pc = R[rd][9:0] (signed)
    OP_BGT  = 12,   // if (R[rs] > R[rt]) pc = R[rd][9:0] (signed)
    OP_BLE  = 13,   // if (R[rs] <= R[rt]) pc = R[rd][9:0] (signed)
    OP_BGE  = 14,   // if (R[rs] >= R[rt]) pc = R[rd][9:0] (signed)
    OP_JAL  = 15,   // R[15] = pc+1, pc = R[rd][9:0]
